...
- <TextWithIcon icon="simple-icons:typescript">**Advanced-level Typescript:**</TextWithIcon>
...
- <TextWithIcon icon="tabler:files">**Monorepo:**</TextWithIcon>
...
- <TextWithIcon icon="simple-icons:react">**React:**</TextWithIcon>
...
- <TextWithIcon icon="simple-icons:express">**ExpressJS:**</TextWithIcon>
...
- <TextWithIcon icon="simple-icons:storybook">**Storybook:**</TextWithIcon>
...
<Alert type="note">
#### Do you forget to mention *TailwindCSS*? 

You might think our project can't live without Tailwind, the most widely used styling framework in the world. Indeed, LifeForge used to rely heavily on Tailwind, but we have decided to migrate away from it in favour of our own dedicated token-based UI library due to a fatal incompatibility between our use-cases and the underlying mechanism of Tailwind. Learn more about it [here](/progress/architectural-graveyard).
</Alert>
</section>
