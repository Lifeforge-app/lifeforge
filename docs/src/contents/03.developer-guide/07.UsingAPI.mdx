...
type CreateItemInput = InferInput<Alert typeof forgeAPI.items.create>['body']
type Item = InferOutput<Alert typeof forgeAPI.items.create>
```
...
type Item = InferOutput<Alert typeof forgeAPI.items.list>[number]
...
type CreateItemBody = InferInput<Alert typeof forgeAPI.items.create>['body']
type UpdateItemBody = InferInput<Alert typeof forgeAPI.items.update>['body']
...
```typescript
type QueryParams = InferInput<Alert typeof forgeAPI.items.list>['query']
```
...
export type Item = InferOutput<Alert typeof forgeAPI.items.list>[number]
