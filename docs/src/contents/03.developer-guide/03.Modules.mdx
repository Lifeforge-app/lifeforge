...
### <FolderHeading icon="material-icon-theme:typescript">client/manifest.ts</FolderHeading>
...
### <FolderHeading icon="material-icon-theme:typescript">client/vite.config.ts</FolderHeading>
...
### <FolderHeading icon="material-icon-theme:folder-i18n">locales/</FolderHeading>
...
### <FolderHeading icon="material-icon-theme:nodejs">package.json</FolderHeading>
...
## <code>Package.json</code> Configuration
